...
class PlayCli(BaseCli):
    ...
    def run(self):
        ...
        checklist_server = checklist_wsgi_server.ChecklistWsgiServer(
            HOST, self.args.port, checklist_app
        )
    ...
    def run_dashboard(self):
        ...
        dashboard_server = checklist_wsgi_server.ChecklistWsgiServer(
            HOST, self.args.port, dashboard_app
        )
